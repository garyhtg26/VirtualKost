                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse"
                                               ...
                                               Saya lupa password akun, apa yang harus saya lakukan?
                                            </button>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Bagaimana agar transaksi saya aman di VirtualKost?
                                            </button>
                                        </h5>
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapseOne">
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Bagaimana cara check-in di kost?
                                            </button>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Bagaimana cara menyewakan kost saya?
                                            </button>
                                        </h5>
                                    </div>
