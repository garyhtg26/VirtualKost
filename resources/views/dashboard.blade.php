        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{ __("Selamat datang di dashboard VirtualKost !") }}
                </div>
            </div>
            <div class="mt-2">
                <!-- State cards -->
                <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
                  ...
                  <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                    <div>
                      ...
                      <span class="text-xl font-semibold">Rp 126.000.000</span>
                  ...
                  <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                    <div>
                      ...
                      <span class="text-xl font-semibold">52 Orang</span>
                      <span class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                        +2.6%
                      </span>
                    </div>
                ...
                <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                  ...
                  <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                      <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Total Pendapatan Bulanan</h4>
                    ...
                    <div class="relative p-4 h-72"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="barChart" style="display: block; height: 256px; width: 608px;" width="912" height="384" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  ...
                  <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    <!-- Card header -->
                    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                      <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Total Pengahasilan</h4>
                    ...
                    <!-- Chart -->
                    <div class="relative p-4 h-72"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="doughnutChart" style="display: block; height: 256px; width: 272px;" width="408" height="384" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                  ...
                  <div class="col-span-1 bg-white rounded-md dark:bg-darker">
                    ...
                    <p class="p-4">
                      <span class="text-2xl font-medium text-gray-500 dark:text-light" id="usersCount">88</span>
                    ...
                    <div class="relative p-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="activeUsersChart" style="display: block; height: 150px; width: 272px;" width="408" height="225" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  ...
                  <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    <!-- Card header -->
                    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                      <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Jumlah Pengunjung</h4>
                      <div class="flex items-center">
                    ...
                    <!-- Chart -->
                    <div class="relative p-4 h-72"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="lineChart" style="display: block; height: 256px; width: 608px;" width="912" height="384" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                </div>
              </div>
