    ...
    <div class="container">
      <div class="forms-container">
        ...
        <div class="signin-signup">
            <form method="POST" action="{{ route('login-dashboard') }}" class="sign-in-form" >
            @csrf
          ...
          <form class="sign-up-form" method="POST" action="{{ route('register-dashboard') }}">
            @csrf
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content" >
            <h2>Baru disini?</h2>
            <p>
              Daftar sebagai pemilik sekarang lalu nikmati sensasi dari virtual tour!
            </p>
        ...
        <div class="panel right-panel">
          <div class="content">
            <h3>Sudah memiliki akun pemilik?</h3>
            <p>
              Segera masuk dan segera berjualan kost anda.
            </p>
