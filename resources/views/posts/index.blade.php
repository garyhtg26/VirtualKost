                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                        <a href="{{ route('posts.show', $post->id) }}" class="border text-white bg-blue-500 hover:border-blue-500 hover:text-white px-4 py-2 rounded-md">SHOW</a>
                                        <a href="{{ route('posts.edit', $post->id) }}" class="border text-white bg-yellow-500 hover:border-yellow-500 hover:text-white px-4 py-2 rounded-md">EDIT</a>
